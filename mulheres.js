...
const cors = require('cors') // estou trazendo pacote cors
const conectaBancoDeDados = require('./bancoDeDados.js') // aqui estou lgando ao arquivo banco de dados
...
async function corrigeMulher(request, response) {
    try{
        const mulherEncontrada = await Mulher.findById(request.parms.id)
